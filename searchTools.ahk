...
#Include lib\SearchGoogle.ahk

SetWorkingDir, %a_scriptDir%
menu, tray, icon, % "lib\icon.ico"
menu, tray, add,
menu, tray, add, &Search, GetSearchText
menu, tray, default, &Search
gui, search: new
gui, search:color, 0x000023
includeSearchBar("search")
gosub, GetSearchText
...
F2::
GetSearchText:
   showGuiWithSearchBar("search", "Search Anything")
return
